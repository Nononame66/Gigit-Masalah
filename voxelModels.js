...
/* ==========================================================
   6. 15 RIVER FISH SPECIES CATALOG WITH LORE & XP
   (unchanged data — only the render style below is faceted)
   ========================================================== */
export const FISH_SPECIES = [
  { id: 'kadal_air', name: 'Nila Sungai', rarity: 'Common', rarityColor: '#94a3b8', minWeight: 0.8, maxWeight: 2.5, basePrice: 25, xpReward: 15, desc: 'Ikan kecil yang lincah berenang di tepi sungai.', symbol: '🦎', colors: [0x10b981, 0x047857, 0xa7f3d0] },
  { id: 'perch', name: 'Wader Sungai', rarity: 'Common', rarityColor: '#94a3b8', minWeight: 0.5, maxWeight: 1.8, basePrice: 30, xpReward: 20, desc: 'Ikan sungai kecil yang sering bersembunyi di antara batu.', symbol: '🐠', colors: [0x15803d, 0x4ade80, 0xfacc15] },
  { id: 'salmon', name: 'Lele Pelangi', rarity: 'Common', rarityColor: '#94a3b8', minWeight: 1.5, maxWeight: 4.2, basePrice: 45, xpReward: 25, desc: 'Daging segar berkilat sisik pelangi emas.', symbol: '🐟', colors: [0xf43f5e, 0xfb7185, 0xe2e8f0] },
  { id: 'koi', name: 'Koi Emas', rarity: 'Rare', rarityColor: '#3b82f6', minWeight: 2.0, maxWeight: 5.5, basePrice: 95, xpReward: 50, desc: 'Koi berkilau jingga keemasan pencetus keberuntungan.', symbol: '🐡', colors: [0xf97316, 0xfbac41, 0xffffff] },
  { id: 'biawak', name: 'Gabus Rawa', rarity: 'Rare', rarityColor: '#3b82f6', minWeight: 3.5, maxWeight: 8.5, basePrice: 140, xpReward: 65, desc: 'Predator rawa yang tangguh dan jarang terlihat.', symbol: '🐊', colors: [0x334155, 0x475569, 0x10b981] },
  { id: 'salamander', name: 'Belut Neon', rarity: 'Rare', rarityColor: '#3b82f6', minWeight: 1.8, maxWeight: 4.5, basePrice: 160, xpReward: 75, desc: 'Salamander air berpendar warna cyan cerah.', symbol: '🦎', colors: [0x06b6d4, 0x67e8f9, 0xfef08a] },
  { id: 'kepiting', name: 'Kepiting Sungai Merah', rarity: 'Rare', rarityColor: '#3b82f6', minWeight: 1.0, maxWeight: 3.0, basePrice: 180, xpReward: 85, desc: 'Kepiting bercangkang merah kuat dengan capit tajam.', symbol: '🦀', colors: [0xef4444, 0xd97706, 0xffffff] },
  { id: 'axolotl', name: 'Axolotl Neon', rarity: 'Epic', rarityColor: '#a855f7', minWeight: 1.2, maxWeight: 3.8, basePrice: 260, xpReward: 120, desc: 'Axolotl misterius bermahkota merah magenta menyala.', symbol: '👾', colors: [0xec4899, 0xf472b6, 0x06b6d4] },
  { id: 'komodo', name: 'Ikan Gabus Raksasa', rarity: 'Epic', rarityColor: '#a855f7', minWeight: 15.0, maxWeight: 45.0, basePrice: 380, xpReward: 180, desc: 'Ikan raksasa yang konon hidup di sungai terdalam.', symbol: '🐉', colors: [0x854d0e, 0xa16207, 0xfef08a] },
  ...
  { id: 'shark', name: 'Hiu Sungai Misterius', rarity: 'Legendary', rarityColor: '#f59e0b', minWeight: 20.0, maxWeight: 50.0, basePrice: 700, xpReward: 350, desc: 'Predator air langka dengan sirip tajam.', symbol: '🦈', colors: [0x475569, 0x64748b, 0xf8fafc] },
  { id: 'lava_kadal', name: 'Ikan Lava', rarity: 'Legendary', rarityColor: '#f59e0b', minWeight: 12.0, maxWeight: 30.0, basePrice: 900, xpReward: 450, desc: 'Ikan aneh dengan sisik merah seperti bara.', symbol: '🔥', colors: [0x18181b, 0xea580c, 0xfacc15] },
  { id: 'golden_kadal', name: 'Ikan Raja Emas', rarity: 'Legendary', rarityColor: '#f59e0b', minWeight: 10.0, maxWeight: 28.0, basePrice: 1200, xpReward: 600, desc: 'Ikan langka berwarna emas yang dipercaya membawa keberuntungan.', symbol: '👑', colors: [0xf59e0b, 0xfef08a, 0xffffff] },
  { id: 'leviathan', name: 'Leviathan Sungai Glitch', rarity: 'Mythic', rarityColor: '#ec4899', minWeight: 35.0, maxWeight: 95.0, basePrice: 1800, xpReward: 900, desc: 'Makhluk sungai purba bersisik kristal neon.', symbol: '🐲', colors: [0x581c87, 0xa855f7, 0x06b6d4] },
  { id: 'cosmic_dragon', name: 'Ikan Kosmik Bintang', rarity: 'Mythic', rarityColor: '#ec4899', minWeight: 40.0, maxWeight: 120.0, basePrice: 2500, xpReward: 1200, desc: 'Ikan misterius yang tubuhnya berpendar seperti langit malam.', symbol: '🌌', colors: [0x312e81, 0x818cf8, 0xf472b6] }
];
